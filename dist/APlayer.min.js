                ...
                return (
                    n(a, function (e, n) {
                        (t += '\n<li onmouseover="$(\'#musicsongid_'+n+'\').popover({ placement:\'left\', trigger:\'manual\', html:true, content:\' \
                                      <a id=\\\'btn_backward_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-backward\\\' alt=\\\'backward\\\' title=\\\'backward\\\' > </a> \
                                      <a id=\\\'btn_play_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-play\\\'> </a> \
                                      <a id=\\\'btn_forward_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-forward\\\'> </a> \
                ...
                return (
                    a.fixed
                        ? ((t += '\n<div class="aplayer-list'),
                          ...
                          (t += s.loading),
                          (t +=
                              '</span>\n                        </span>\n                    </div>\n                </div>\n            </div>\n            <div class="aplayer-time">\n                <div class="aplayer-volume-wrap">\n                    <span class="aplayer-time-inner">\n                    <span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">00:00</span>\n                </span>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-volume-down">\n                        '),
                          (t += s.volumeDown),
                          (t +=
                              '\n                    </button>\n                    <div class="aplayer-volume-bar-wrap">\n                        <div class="aplayer-volume-bar">\n                            <div class="aplayer-volume" style="height: 80%; background: '),
                          (t += o(a.theme)),
                          (t += ';"></div>\n                        </div>\n                    </div>\n                </div>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-back">\n                    '),
                          (t += s.skip),
                          (t += '\n                </button>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-play">\n                    '),
                          (t += s.play),
                          (t += '\n                </button>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-forward">\n                    '),
                          (t += s.skip),
                          (t += '\n                </button>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-order">\n                    '),
                          "list" === a.order ? (t += s.orderList) : "random" === a.order && (t += s.orderRandom),
                          (t += '\n                </button>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-loop">\n                    '),
                          "one" === a.loop ? (t += s.loopOne) : "all" === a.loop ? (t += s.loopAll) : "none" === a.loop && (t += s.loopNone),
                          (t += '\n                </button>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-menu">\n                    '),
                          (t += s.menu),
                          (t += '\n                </button>\n                <button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" type="button" class="aplayer-icon aplayer-icon-lrc">\n                    '),
                          (t += s.lrc),
                          (t += '\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class="aplayer-notice"></div>\n    <div class="aplayer-miniswitcher"><button style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important; width: 20px !important; height: 20px !important;" class="aplayer-icon">'),
                          (t += s.right),
