    ...
    return (function (e) {
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                return (
                    n(a, function (e, n) {
                        (t += '\n<li onmouseover="$(\'#musicsongid_'+n+'\').popover({ placement:\'left\', trigger:\'manual\', html:true, content:\' \
                                      ...
                                      \' }); $(\'.musicsong_popover\').popover(\'hide\'); $(\'#musicsongid_'+n+'\').popover(\'show\');" id="musicsongid_'+n+'" class="musicsong_popover" > <span class="aplayer-list-cur" style="background-color: '),
