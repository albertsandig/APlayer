                ...
                return (
                    n(a, function (e, n) {
                        ...
                        (t += '\n<li onmouseover="$(\'#musicsongid_'+n+'\').popover({ container:\'#'+currentaplayer_selected+'\', placement:\'left\', trigger:\'manual\', html:true, content:\' \
                                      ...
                                      \' }); $(\'.musicsong_popover\').popover(\'hide\'); $(\'#current_musicsongid_n\').val('+n+'); $(\'#musicsongid_'+n+'\').popover(\'show\');" id="musicsongid_'+n+'" class="musicsong_popover" > <span class="aplayer-list-cur" style="background-color: '),
