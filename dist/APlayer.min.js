                ...
                return (
                    a.fixed
                        ? ((t += '\n<div class="aplayer-list'),
                          ...
                          (t += o(a.theme)),
                          (t += ';"></div>\n                        </div>\n                    </div>\n                </div>\n                <button type="button" class="aplayer-icon aplayer-icon-back" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          (t += s.skip),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-play" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          (t += s.play),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-forward" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          (t += s.skip),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-order" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          "list" === a.order ? (t += s.orderList) : "random" === a.order && (t += s.orderRandom),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-loop" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          "one" === a.loop ? (t += s.loopOne) : "all" === a.loop ? (t += s.loopAll) : "none" === a.loop && (t += s.loopNone),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-menu" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          (t += s.menu),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-lrc" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">\n                    '),
                          (t += s.lrc),
                          (t += '\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class="aplayer-notice"></div>\n    <div class="aplayer-miniswitcher"><button class="aplayer-icon" style="background-color: #d6d6d6; padding: 5px; margin-top: -15px; border-radius: 5px; opacity: 1 !important;">'),
                          (t += s.right),
