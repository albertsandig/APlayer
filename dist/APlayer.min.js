        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                var t = "",
                  ...
                  return (
                      n(a, function (e, n) {
                          var cm = document.getElementById('current_musicsongid_n').value;
                          var currentaplayer_selected = document.getElementById('currentaplayer_selected').value;
                          if(currentaplayer_selected != 'songlist_aplayer')  {
                            currentaplayer_selected = 'album_aplayer';
                          }
                          //console.log(currentaplayer_selected);
                          // ((s == n) ? "pause":"play")
                          // $(\'#current_musicsongid_n\').val('+n+');
                          //<a id=\\\'btn_play_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-' + (  (( document.getElementById('current_musicsongid_n').value == n ) ? "pause":"play"))  + ' \\\' alt=\\\'Play\\\' title=\\\'Play\\\' > </a> \

                          //if( $('#current_musicsongid_n').val() == 'n' ) { $('#btn_play_musicsongid_'+n).attr('class','btn btn_default btn-sm btncustomrawplayer fa fa-pause'); } else { $('#btn_play_musicsongid_'+n).attr('class','btn btn_default btn-sm btncustomrawplayer fa fa-play'); }

                            (t += '\n<li onmouseover=" $(\'#musicsongid_'+n+'\').popover({ container:\'#'+currentaplayer_selected+'\', placement:\'left\', trigger:\'manual\', html:true, content:\' \
                                        <div id=\\\'for_volume_'+n+'\\\' class=\\\'for_volume\\\' >  </div> \
                                        <a id=\\\'btn_volume_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-volume-up\\\' alt=\\\'Adjust Volume\\\' title=\\\'Adjust Volume\\\' > </a> \
                                        <a id=\\\'btn_backward_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-backward\\\' alt=\\\'Previous Song\\\' title=\\\'Previous Song\\\' > </a> \
                                        <a id=\\\'btn_play_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-play\\\' alt=\\\'Play\\\' title=\\\'Play\\\' > </a> \
                                        <a id=\\\'btn_forward_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-forward\\\' alt=\\\'Next Song\\\' title=\\\'Next Song\\\' > </a> \
                                        <a id=\\\'btn_loop_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-redo\\\' alt=\\\'Repeat Song\\\' title=\\\'Repeat Song\\\' >  </a> \
                                        <a id=\\\'btn_random_musicsongid_'+n+'\\\' class=\\\'btn btn_default btn-sm btncustomrawplayer fa fa-random\\\' alt=\\\'Random Song\\\' title=\\\'Random Song\\\' >  </a> \
                                        \' }); $(\'.musicsong_popover\').popover(\'hide\'); $(\'#musicsongid_'+n+'\').popover(\'show\'); \
                                        setTimeout(function(){ \
                                          if( $(\'#current_musicsongid_n\').val() == '+n+' ) { \
                                            if( $(\'.aplayer-button\').attr(\'class\') == \'aplayer-button aplayer-pause\' ) { \
                                                $(\'#btn_play_musicsongid_'+n+'\').attr(\'class\',\'btn btn_default btn-sm btncustomrawplayer fa fa-pause\'); \
                                                $(\'#btn_play_musicsongid_'+n+'\').attr(\'alt\',\'Pause\'); \
                                                $(\'#btn_play_musicsongid_'+n+'\').attr(\'title\',\'Pause\'); \
                                            } else { \
                                              $(\'#btn_play_musicsongid_'+n+'\').attr(\'class\',\'btn btn_default btn-sm btncustomrawplayer fa fa-play\'); \
                                              $(\'#btn_play_musicsongid_'+n+'\').attr(\'alt\',\'Play\'); \
                                              $(\'#btn_play_musicsongid_'+n+'\').attr(\'title\',\'Play\'); \
                                            } \
                                          } else {  } \
                                        }, 1); \
                                        " id="musicsongid_'+n+'" class="musicsong_popover" > <span class="aplayer-list-cur" style="background-color: '),
                ...
                return (
                    a.fixed
                        ? ((t += '\n<div class="aplayer-list'),
                          ...
                          //(t += ">\n    <ol onmouseout=\"alertt(); $('.musicsong_popover').popover('hide');\" alert('test(); "),
                          (t += ">\n    <ol "),
                          a.listMaxHeight && ((t += ' style="max-height: '), (t += o(a.listMaxHeight)), (t += '"')),
                          (t += ">\n        "),
                          l(n(1)(u({ theme: a.theme, audio: a.audio, index: 1 }))),
                          (t += '\n    </ol>\n <input id="repeat_song_index" name="repeat_song_index" type="hidden"> <input id="current_volume" name="current_volume" type="hidden" value="0.8"> </div>\n<div class="aplayer-body">\n    <div class="aplayer-pic" style="'),
                          r && ((t += "background-color:red; background-image: url(&quot;"), (t += o(r)), (t += "&quot;);")),
                          (t += "background-color: "),
                          (t += o(a.theme)),
                          (t += ';">\n        <div class="aplayer-button aplayer-play">'),
                          (t += s.play),
                          (t +=
                              '</div>\n    </div>\n    <div class="aplayer-info" style="display: none;">\n        <div class="aplayer-music">\n            <span class="aplayer-title">No audio</span>\n            <span class="aplayer-author"></span>\n        </div>\n        <div class="aplayer-controller">\n            <div class="aplayer-bar-wrap" style="margin-top: -8px;">\n                <div class="aplayer-bar">\n                    <div class="aplayer-loaded" style="width: 0"></div>\n                    <div class="aplayer-played" style="width: 0; background: '),
                          (t += o(a.theme)),
                          ...
                          (t += s.loading),
                          (t +=
                              '</span>\n                        </span>\n                    </div>\n                </div>\n            </div>\n            <div class="aplayer-time" style="margin-top: -14px;">\n                <div class="aplayer-volume-wrap">\n                    <span class="aplayer-time-inner">\n                    <span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">00:00</span>\n                </span>\n                <button type="button" class="aplayer-icon aplayer-icon-volume-down" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                        '),
                          (t += s.volumeDown),
                          (t +=
                              '\n                    </button>\n                    <div class="aplayer-volume-bar-wrap" style="right:7px;bottom:20px;">\n                        <div class="aplayer-volume-bar">\n                            <div class="aplayer-volume" style="height: 80%; background: '),
                          (t += o(a.theme)),
                          (t += ';"></div>\n                        </div>\n                    </div>\n                </div>\n                <button type="button" class="aplayer-icon aplayer-icon-back" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          (t += s.skip),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-play" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          (t += s.play),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-forward" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          (t += s.skip),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-order" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          "list" === a.order ? (t += s.orderList) : "random" === a.order && (t += s.orderRandom),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-loop" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          "one" === a.loop ? (t += s.loopOne) : "all" === a.loop ? (t += s.loopAll) : "none" === a.loop && (t += s.loopNone),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-menu" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          (t += s.menu),
                          (t += '\n                </button>\n                <button type="button" class="aplayer-icon aplayer-icon-lrc" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">\n                    '),
                          (t += s.lrc),
                          (t += '\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class="aplayer-notice"></div>\n    <div class="aplayer-miniswitcher"><button class="aplayer-icon" style="background-color: #ddd;padding: 7px 10px;border-radius: 0px;">'),
                          (t += s.right),
                        ...
                        : ((t += '\n<div class="aplayer-body">\n    <div class="aplayer-pic" style="'),
                          ...
                          a.listMaxHeight && ((t += ' style="max-height: '), (t += o(a.listMaxHeight)), (t += '"')),
                          (t += ">\n    <ol"),
                          //(t += ">\n    <ol onmouseleave=\"$('.aplayer-withlist').popover('hide');\" "),
                          a.listMaxHeight && ((t += ' style="max-height: '), (t += o(a.listMaxHeight)), (t += '"')),
                          (t += ">\n        "),
                          l(n(1)(u({ theme: a.theme, audio: a.audio, index: 1 }))),
                          (t += "\n    </ol>\n <input id='repeat_song_index' name='repeat_song_index' type='hidden'> <input id='current_volume' name='current_volume' type='hidden' value='0.8'> </div>\n")),
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        this.on("play", function () {
                                            ...
                                            $('#current_musicsongid_n').val(e.list.index);
                                            $('#btn_play_musicsongid_' + e.list.index).attr('class','btn btn_default btn-sm btncustomrawplayer fa fa-pause');
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        $('#btn_play_musicsongid_' + e.list.index).attr('class','btn btn_default btn-sm btncustomrawplayer fa fa-play');
                                    },
                                },
                                {
